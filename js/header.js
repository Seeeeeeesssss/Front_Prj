...
function tokenLoad(){
    ...
    } else if(loginRecent === "no"){
        loginToken = "<a href = './html/login.html' id = 'login'><img src = './img/headerImg/login.png'></a>";
    }
}
function logOut(){
    localStorage.setItem("loginRecent", "no");
        ...
        "<div id = 'navi'>" +
            ...
            "<label for = 'searchBar'>"+
                "<fieldset>"+
                    ...
                    "<button type = 'button' onclick = 'textclear(searchBar)'><img src = './img/headerImg/clear.png'></button>"+
                    "<button type = 'button'><img src = './img/headerImg/search.png'></button>"+
                "</fieldset>"+
            "</label>";
